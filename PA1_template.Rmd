...
As we can see from the histogram, the daily total of steps is most commonly between 10000 and 15000. The mean number is `r meanSteps` and the median is `r medianSteps`.
...
On average, the highest number of steps is taken during the 5-minute interval starting at `r maxInterval`.
